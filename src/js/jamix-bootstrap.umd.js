(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.jamixBootstrap = factory());
  ...
  */
  ...
  function requireToast () {
  	if (hasRequiredToast) return toast$1.exports;
  	hasRequiredToast = 1;
  	(function (module, exports) {
  		(function (global, factory) {
  		  module.exports = factory(requireBaseComponent(), requireEventHandler(), requireComponentFunctions(), requireUtil()) ;
  		})(toast, (function (BaseComponent, EventHandler, componentFunctions_js, index_js) {
  		  /**
  		   * --------------------------------------------------------------------------
  		   * Bootstrap toast.js
  		   * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
...
//# sourceMappingURL=jamix-bootstrap.umd.js.map
